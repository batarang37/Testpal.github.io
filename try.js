...
submit.addEventListener('click',function (e) {
    ...
    if (count2==0) {
        ...
        setTimeout(() => {
            ...
            twentynine.innerHTML="Dyslexia"+'&nbsp'+dyslexia+'</br>'+
                                "Dyscalculia"+'&nbsp'+dyscalculia+'</br>'+
                                "Dysgraphia"+'&nbsp'+dysgraphia+'</br>'+
                                "Dyspraxia"+'&nbsp'+dyspraxia+'</br>'+
                                "Autism"+'&nbsp'+autism+'</br>'+
                                "ADHD"+'&nbsp'+adhd+'</br>';
            console.log('vangana vankamana');
